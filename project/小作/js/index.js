			...
			DOMReady(function(){
				...
				var oDiv=oMbmask.getElementsByTagName('div')[0];
					...
					document.body.onmousemove=function(ev){
						...
						oDiv.style.mozMaskPosition=l+'px '+t+'px';
						oDiv.style.webkitMaskPosition=l+'px '+t+'px';
						oDiv.style.msMaskPosition=l+'px '+t+'px';
				}
			})
			...
			DOMReady(function(){
				...
				for(var i=1;i<N;i++){
					...
					aLi[3].onclick=function(){	
						oBbcon.innerHTML='<p>联系电话:18333210063</p>'+
															
															'<p>电子邮箱:wuzeshi2012@163.com</p>';
															
					};
					aLi[4].onclick=function(){	
						oBbcon.innerHTML='<p>兴趣:读书/电影</p>'
															;
