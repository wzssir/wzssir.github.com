			...
			$('.login_btn').click(function(){
				if(_switch){
					...
					if($('.J_addr_radio .checked').attr('data-value')==2){
						...
						data={'type':_type,'name':_name,'tel':_tel,'fax':_fax,'company':_company,'country':_country,'street':_street,'floor':_floor,'city':_city,'province':_province,'postcode':_postcode,'country1':_country1,'street1':_street1,'floor1':_floor1,'city1':_city1,'province1':_province1,'postcode1':_postcode1};
					}else{
						data={'type':_type,'name':_name,'tel':_tel,'fax':_fax,'company':_company,'country':_country,'street':_street,'floor':_floor,'city':_city,'province':_province,'postcode':_postcode};
					}
					//alert(_floor1);
					/*$.ajax({
						url:"data.php"
